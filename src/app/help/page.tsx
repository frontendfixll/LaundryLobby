...
export default function HelpCenterPage() {
  ...
  const fetchCategories = async () => {
    try {
      const response = await tenantBlogApi.getTenantCategories(TENANT_ID)
  ...
  const fetchFeaturedPosts = async () => {
    try {
      const response = await tenantBlogApi.getTenantPopularPosts(TENANT_ID, 3, 'customer')
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-red-800">Error loading help articles</h3>
